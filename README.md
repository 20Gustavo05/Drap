...
def widgets_frame2() aqui, estão sendo criados, armazenados e organizados TODAS as informações e funcionalidades de widgets que estejam dentro de QUALQUER frame 2 do sistema. Atualmente, 
                      aqui também está contido as informações do frame3_aba2
